      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-xl shadow-lg p-8 mb-8">
              <div class="text-center">
                  ...
                  <h1 class="text-3xl font-extrabold tracking-tight">Tambah Data Kamus BU</h1>
          ...
          <div class="bg-white shadow-xl rounded-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
              <form action="{{ route('kamus.store') }}" method="POST" class="p-8" x-data="{ form: { nama_bu: '{{ old('nama_bu') }}', id_izin: '{{ old('id_izin') }}', kbli: '{{ old('kbli') }}', kode_bu: '{{ old('kode_bu') }}' } }">
                  @csrf
