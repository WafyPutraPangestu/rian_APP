          ...
          <div class="overflow-x-auto">
              <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-sm">
                  ...
                  <tbody>
                      @forelse ($rekapanTigas as $rekap)
                          <tr class="border-b border-gray-200 hover:bg-gray-50">
                              ...
                              <td class="px-4 py-3 text-sm">
                                  ...
                                  <form action="{{ route('rekapantiga.destroy', $rekap->id) }}" method="POST" class="inline-block">
                                      @csrf
                                      @method('DELETE')
                      ...
                      @empty
                          <tr>
                              <td colspan="15" class="px-4 py-3 text-sm text-gray-500 text-center">Belum ada data rekap.</td>
                          </tr>
                      @endforelse
                  </tbody>
              </table>
