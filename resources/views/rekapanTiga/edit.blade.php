<x-layout>
  <div class="min-h-screen bg-gray-50 py-8">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold text-gray-900 mb-6">Edit Rekap Tiga</h1>
          @if (session('success'))
          ...
          @endif
          <form action="{{ route('rekapantiga.update', $rekapanTiga->id) }}" method="POST">
              @csrf
              @method('PUT')
              <div x-data="rekapForm()">
                  <div class="mb-4">
                      ...
                      <input type="text" id="kode_bu" x-model="search" @input.debounce.500ms="fetchData"
                             name="kode_bu" value="{{ old('kode_bu', $rekapanTiga->kode_bu) }}"
                             placeholder="Masukkan kode BU..."
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_bu" x-model="nama_bu" name="nama_bu" readonly
                             value="{{ old('nama_bu', $rekapanTiga->nama_bu) }}"
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="id_izin" x-model="id_izin" name="id_izin" readonly
                             value="{{ old('id_izin', $rekapanTiga->id_izin) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                      @error('id_izin')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="kbli" x-model="kbli" name="kbli" readonly
                             value="{{ old('kbli', $rekapanTiga->kbli) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                      @error('kbli')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="kab_kota" name="kab_kota"
                             value="{{ old('kab_kota', $rekapanTiga->kab_kota) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('kab_kota')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="date" id="tgl_oss" name="tgl_oss"
                             value="{{ old('tgl_oss', $rekapanTiga->tgl_oss) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('tgl_oss')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="date" id="tgl_lsbu" name="tgl_lsbu"
                             value="{{ old('tgl_lsbu', $rekapanTiga->tgl_lsbu) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('tgl_lsbu')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="admin" name="admin"
                             value="{{ old('admin', $rekapanTiga->admin) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('admin')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="kode_ttp" name="kode_ttp"
                             value="{{ old('kode_ttp', $rekapanTiga->kode_ttp) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('kode_ttp')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="tim_tinjauan" name="tim_tinjauan"
                             value="{{ old('tim_tinjauan', $rekapanTiga->tim_tinjauan) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('tim_tinjauan')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="date" id="tgl_penunjukan" name="tgl_penunjukan"
                             value="{{ old('tgl_penunjukan', $rekapanTiga->tgl_penunjukan) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="mb-4">
                      ...
                      <textarea id="catatan" name="catatan"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('catatan', $rekapanTiga->catatan) }}</textarea>
                      @error('catatan')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  </div>
                  <div class="flex space-x-4">
                      ...
                      <a href="{{ route('rekapantiga.index') }}"
  ...
  <script>
      document.addEventListener('alpine:init', () => {
          Alpine.data('rekapForm', () => ({
              search: '{{ old('kode_bu', $rekapanTiga->kode_bu) }}',
              nama_bu: '{{ old('nama_bu', $rekapanTiga->nama_bu) }}',
              id_izin: '{{ old('id_izin', $rekapanTiga->id_izin) }}',
              kbli: '{{ old('kbli', $rekapanTiga->kbli) }}',
              error: '',
              async fetchData() {
