<x-layout>
  <div class="min-h-screen bg-gray-50 py-8">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold text-gray-900 mb-6">Edit Rekap Satu</h1>
          @if (session('success'))
          ...
          @endif
          <form action="{{ route('rekapansatu.update', $rekapanSatu->id) }}" method="POST">
              @csrf
              @method('PUT')
              <div x-data="rekapForm()">
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_bu" x-model="search" @input.debounce.500ms="fetchData"
                             name="nama_bu" value="{{ old('nama_bu', $rekapanSatu->nama_bu) }}"
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="id_izin" x-model="id_izin" name="id_izin" readonly
                             value="{{ old('id_izin', $rekapanSatu->id_izin) }}"
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="kbli" x-model="kbli" name="kbli" readonly
                             value="{{ old('kbli', $rekapanSatu->kbli) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                      @error('kbli')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="asosiasi" name="asosiasi"
                             value="{{ old('asosiasi', $rekapanSatu->asosiasi) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('asosiasi')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="kota_kab" name="kota_kab"
                             value="{{ old('kota_kab', $rekapanSatu->kota_kab) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('kota_kab')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="date" id="tanggal_pembayaran" name="tanggal_pembayaran"
                             value="{{ old('tanggal_pembayaran', $rekapanSatu->tanggal_pembayaran) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_ttp" name="nama_ttp"
                             value="{{ old('nama_ttp', $rekapanSatu->nama_ttp) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('nama_ttp')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_abu_1" name="nama_abu_1"
                             value="{{ old('nama_abu_1', $rekapanSatu->nama_abu_1) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('nama_abu_1')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_abu_2" name="nama_abu_2"
                             value="{{ old('nama_abu_2', $rekapanSatu->nama_abu_2) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('nama_abu_2')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_pemutus_1" name="nama_pemutus_1"
                             value="{{ old('nama_pemutus_1', $rekapanSatu->nama_pemutus_1) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_pemutus_2" name="nama_pemutus_2"
                             value="{{ old('nama_pemutus_2', $rekapanSatu->nama_pemutus_2) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="nama_pemutus_3" name="nama_pemutus_3"
                             value="{{ old('nama_pemutus_3', $rekapanSatu->nama_pemutus_3) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="mtd_byr" name="mtd_byr"
                             value="{{ old('mtd_byr', $rekapanSatu->mtd_byr) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('mtd_byr')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="number" id="jumlah_biaya" name="jumlah_biaya" step="0.01"
                             value="{{ old('jumlah_biaya', $rekapanSatu->jumlah_biaya) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('jumlah_biaya')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="mb-4">
                      ...
                      <input type="number" id="potongan_admin" name="potongan_admin" step="0.01"
                             value="{{ old('potongan_admin', $rekapanSatu->potongan_admin) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="status_terbit" name="status_terbit"
                             value="{{ old('status_terbit', $rekapanSatu->status_terbit) }}"
                             class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                      @error('status_terbit')
                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                      @enderror
                  ...
                  <div class="flex space-x-4">
                      ...
                      <a href="{{ route('rekapansatu.index') }}"
  ...
  <script>
      document.addEventListener('alpine:init', () => {
          Alpine.data('rekapForm', () => ({
              search: '{{ old('nama_bu', $rekapanSatu->nama_bu) }}',
              id_izin: '{{ old('id_izin', $rekapanSatu->id_izin) }}',
              kbli: '{{ old('kbli', $rekapanSatu->kbli) }}',
              error: '',
              async fetchData() {
